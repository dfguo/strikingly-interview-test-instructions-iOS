...
2. **Give Me A Word**
  ...
  - What kinds of Words will appear in the game? please read [Words](https://github.com/dfguo/strikingly-interview-test-instructions/blob/master/README.md#words) section 
  - Request & Response
    * Request:
      <pre><code>
      {
